...
def my_parallel_wrapper_fn_ic3(env_fn, seed=None):
    def par_fn(**kwargs):
        env = env_fn(**kwargs)
        env = aec_to_parallel_wrapper_ic3(env, seed)
...
# from utils.conversion.py
class aec_to_parallel_wrapper_ic3(aec_to_parallel_wrapper):
...
my_parallel_env_ic3 = my_parallel_wrapper_fn_ic3(pursuit_v4.env)
