...
def my_parallel_wrapper_fn_no_message(env_fn, seed=None):
    def par_fn(**kwargs):
        # remove from kwagrs
        ...
        env = env_fn(**kwargs)
        env = aec_to_parallel_wrapper_no_message(env, seed)
...
# from utils.conversion.py
class aec_to_parallel_wrapper_no_message(aec_to_parallel_wrapper):
...
my_parallel_env_no_message = my_parallel_wrapper_fn_no_message(pursuit_v4.env)
